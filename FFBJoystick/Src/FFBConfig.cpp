...
#define MOTOR_MAX_TORQUE		6000
#define CHECKSUM				0
#define REQUEST_INTERVAL		10000 //(microseconds)
#define XY_FORCE_DEADZONE		5
#define DEFAULT_HOME_SPEED		300
#define PID_OUTPUT				4000
...
const SYS_CONFIG_t SysConfig_default = {
							...
							GAIN_PARAM{127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127},
							GAIN_PARAM{127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127},
							PID_PARAM{PID_OUTPUT, 0.10f, 0.80f, 2.00f, 0.07f},
							PID_PARAM{PID_OUTPUT, 0.10f, 0.70f, 4.00f, 0.02f},
							...
							FILTER_PARAM{50.0,0.2,50.0,0.2,50.0,0.2,50.0,0.2},
							CHECKSUM};
